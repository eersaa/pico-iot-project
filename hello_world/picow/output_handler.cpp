...
extern "C" void on_pwm_wrap() {
  ...
  pwm_clear_irq(pwm_gpio_to_slice_num(CYW43_WL_GPIO_LED_PIN));
  // Square the value to make the LED's brightness appear more linear
  // Note this range matches with the wrap value
  pwm_set_gpio_level(CYW43_WL_GPIO_LED_PIN, g_led_brightness * g_led_brightness);
}
...
void init_pwm_fade() {
  ...
  uint slice_num = pwm_gpio_to_slice_num(CYW43_WL_GPIO_LED_PIN);
